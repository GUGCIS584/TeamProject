                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
							<div class="col-md-12 text-center">
                                    <h2 style="margin-top:0;">BULK STUDENTS</h2><br>
                             </div> 
                                   


                                       <div class="col-md-12 text-center">
                                       <label>If you want to submit bulk students so download a csv template and upload it with the bulk students data.<br><br><br></label>
                                       <div class="row">
                                       <div class="col-6"><a href="student.csv" download><button type="button" class="btn btn-dark pull-right"><i class="fa fa-download "></i> DOWNLOAD</button></a></div>
